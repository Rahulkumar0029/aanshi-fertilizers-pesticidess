...
`,_=({reverseOrder:a,position:b="top-center",toastOptions:d,gutter:f,children:g,toasterId:h,containerStyle:i,containerClassName:j})=>{let{toasts:k,handlers:l}=H(d,h);return e.createElement("div",{"data-rht-toaster":h||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...i},className:j,onMouseEnter:l.startPause,onMouseLeave:l.endPause},k.map(d=>{let h,i,j=d.position||b,k=l.calculateOffset(d,{reverseOrder:a,gutter:f,defaultPosition:b}),m=(h=j.includes("top"),i=j.includes("center")?{justifyContent:"center"}:j.includes("right")?{justifyContent:"flex-end"}:{},{left:0,right:0,display:"flex",position:"absolute",transition:c?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${k*(h?1:-1)}px)`,...h?{top:0}:{bottom:0},...i});return e.createElement(Z,{id:d.id,key:d.id,onHeightUpdate:l.updateHeight,className:d.visible?$:"",style:m},"custom"===d.type?s(d.message,d):g?g(d):e.createElement(Y,{toast:d,position:j}))}))};a.s(["CheckmarkIcon",()=>Q,"ErrorIcon",()=>L,"LoaderIcon",()=>N,"ToastBar",()=>Y,"ToastIcon",()=>V,"Toaster",()=>_,"default",()=>F,"resolveValue",()=>s,"toast",()=>F,"useToaster",()=>H,"useToasterStore",()=>D],6704)},70047,a=>{"use strict";let b=(0,a.i(70106).default)("leaf",[["path",{d:"M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z",key:"nnexq3"}],["path",{d:"M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12",key:"mt58a7"}]]);a.s(["Leaf",()=>b],70047)},33508,a=>{"use strict";let b=(0,a.i(70106).default)("x",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]);a.s(["X",()=>b],33508)},38679,a=>{"use strict";var b=a.i(87924),c=a.i(38246);let d=(0,a.i(70106).default)("menu",[["path",{d:"M4 5h16",key:"1tepv9"}],["path",{d:"M4 12h16",key:"1lakjw"}],["path",{d:"M4 19h16",key:"1djgab"}]]);var e=a.i(33508),f=a.i(70047),g=a.i(50944),h=a.i(72131);function i(){let[a,i]=(0,h.useState)(!1),[j,k]=(0,h.useState)(null),[l,m]=(0,h.useState)(!0),n=(0,g.usePathname)();(0,h.useEffect)(()=>{(async()=>{try{let a=await fetch("/api/auth/me",{credentials:"include",cache:"no-store"});if(a.ok){let b=await a.json();k(b.role||null)}else k(null)}catch{k(null)}finally{m(!1)}})()},[n]);let o=[{name:"Home",href:"/"},{name:"Products",href:"/products"},..."owner"===j?[{name:"Admin Dashboard",href:"/owner"},{name:"Order Inquiries",href:"/owner/orders"}]:"user"===j?[{name:"My Activity",href:"/my-orders"},{name:"Wholesale",href:"/wholesale"}]:l?[]:[{name:"About Us",href:"/about"},{name:"Wholesale",href:"/wholesale"},{name:"Login",href:"/login"}]],p=async()=>{try{await fetch("/api/auth/logout",{method:"POST"})}finally{window.location.href="/login"}};return(0,b.jsxs)("header",{className:"sticky top-0 z-50 border-b border-border bg-white shadow-sm",children:[(0,b.jsxs)("div",{className:"container mx-auto flex items-center justify-between px-4 py-4",children:[(0,b.jsxs)(c.default,{href:"/",className:"flex items-center gap-2",children:[(0,b.jsx)(f.Leaf,{className:"h-8 w-8 text-primary"}),(0,b.jsxs)("div",{className:"flex flex-col",children:[(0,b.jsx)("span",{className:"text-xl font-bold leading-tight text-primary",children:"AANSHI"}),(0,b.jsx)("span",{className:"text-xs font-medium uppercase tracking-wider text-secondary",children:"Fertilizers & Pesticides"})]})]}),(0,b.jsxs)("nav",{className:"hidden items-center gap-8 md:flex",children:[o.map(a=>(0,b.jsx)(c.default,{href:a.href,className:"font-medium text-foreground transition-colors hover:text-primary",children:a.name},a.name)),null!==j&&!l&&(0,b.jsx)("button",{onClick:p,className:"cursor-pointer rounded-full bg-red-50 px-5 py-2 font-semibold text-red-600 transition-all hover:bg-red-100",children:"Logout"}),(0,b.jsx)(c.default,{href:"/wholesale",className:"rounded-full bg-primary px-5 py-2 font-semibold text-white transition-all hover:opacity-90",children:"Wholesale Inquiry"})]}),(0,b.jsx)("button",{className:"text-foreground md:hidden",onClick:()=>i(!a),"aria-label":"Toggle menu",children:a?(0,b.jsx)(e.X,{size:28}):(0,b.jsx)(d,{size:28})})]}),a&&(0,b.jsxs)("nav",{className:"animate-in slide-in-from-top flex flex-col gap-4 border-t border-border bg-white px-4 py-6 shadow-lg duration-300 md:hidden",children:[o.map(a=>(0,b.jsx)(c.default,{href:a.href,className:"border-b border-muted py-2 text-lg font-medium transition-colors hover:text-primary",onClick:()=>i(!1),children:a.name},a.name)),null!==j&&!l&&(0,b.jsx)("button",{onClick:async()=>{i(!1),await p()},className:"border-b border-muted py-2 text-left text-lg font-medium text-red-600 transition-colors hover:text-red-700",children:"Logout"}),(0,b.jsx)(c.default,{href:"/wholesale",className:"mt-2 rounded-lg bg-primary py-3 text-center font-bold text-white",onClick:()=>i(!1),children:"Wholesale Inquiry"})]})]})}a.s(["default",()=>i],38679)}];

//# sourceMappingURL=%5Broot-of-the-server%5D__ef488543._.js.map