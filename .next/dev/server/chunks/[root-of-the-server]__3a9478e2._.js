...
function matchesProtectedPath(pathname, paths) {
...
async function proxy(request) {
    ...
    const isPublicRoute = pathname === "/" || pathname === "/login" || pathname === "/products" || pathname.startsWith("/products/") || pathname === "/about" || pathname === "/wholesale" || pathname === "/forgot-password" || pathname.startsWith("/reset-password/");
    if (isPublicRoute) {
